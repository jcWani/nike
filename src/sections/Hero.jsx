...
function Hero() {
  ...
  return (
    <section
      id="home"
      className="max-container flex min-h-dvh w-full flex-col justify-center gap-10 xl:flex-row"
    >
      <div className="max-xl:padding-x relative flex w-full flex-col items-start justify-center pt-28 xl:w-2/5">
        ...
        <p className="mb-14 mt-6 font-montserrat text-lg leading-8 text-slate-gray sm:max-w-sm">
          Discover styliosh Nike arrivals, quality comfort, and innovation for
          your active life.
        </p>
      ...
      <div className="xl:min relative flex flex-1 items-center justify-center bg-primary bg-hero bg-cover bg-center max-xl:py-40 xl:min-h-dvh">
        <img
          src={bigShoeImg}
          alt="shoe collection"
          width={610}
